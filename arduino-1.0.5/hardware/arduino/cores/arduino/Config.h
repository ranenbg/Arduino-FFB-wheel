...
#define PARAM_ADDR_BRK_PRES      0x15 //milos, max brake pressure
#define PARAM_ADDR_DSK_EFFC      0x16 //milos, desktop effects (byte contents is in effstate)
#define PARAM_ADDR_ENC_CPR       0x17 //milos, encoder CPR
#define PARAM_ADDR_PWM_SET       0x19 //milos, PWM settings and frequency (byte contents is in pwmstate)
