...
#define SAMPLES 			2									// no of samples in moving average data set, value must be 2, 4, 8, 16, 32 or 64
...
#if (SAMPLES  != 2) & (SAMPLES  != 4) & (SAMPLES  != 8) & (SAMPLES  != 16) & (SAMPLES  != 32) & (SAMPLES  != 64)
