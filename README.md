...
Firmware version string consits of 3 digits and some letters (example: fw-v180ahz). The first two digits (XX) are main firmware version, while the 3rd digit (0,1,2,3) stands for:
