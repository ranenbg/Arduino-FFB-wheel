...
/*=========================================================================
    ...
    -----------------------------------------------------------------------*/
    #define ADS1015_CONVERSIONDELAY         (1) //milos, modified, original was 2
    #define ADS1115_CONVERSIONDELAY         (2) //milos, modified, original was 8
/*=========================================================================*/
...
protected:
 ...
 public:
  ...
  void begin(void);
  int16_t   readADC_SingleEnded(uint8_t channel); //milos, was uint16_t
